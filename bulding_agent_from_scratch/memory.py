...
class Memory(BaseModel):
    ...
    def get_entry(self, section_name: str) -> str or None:
        """
        Retrieves the first entry from the specified section of memory.

        Args:
            section_name (str): Name of the section to retrieve the entry from.

        Returns:
            MemoryEntry: The first entry in the specified section, or None if not found.
        """
        for section in self.sections:
            if section.name == section_name and section.entries:
...
if __name__ == '__main__':
    ...
    memory.add_entry("Python", "It is a programming language.")
    memory.add_entry("Python", "Was created by Guido van Rossum.")
    memory.add_entry("Python", "It is easy to learn.")
    memory.add_entry("Python", "It is widely used in data science.")

    # Add JavaScript-related facts
    memory.add_entry("JavaScript", "It is a scripting language.")
    memory.add_entry("JavaScript", "It is used for web development, and can run in the server with Node.js.")
    memory.add_entry("JavaScript", "It is dynamically typed.")

    # Print the structured memory
    print(memory.get_entry("Python"))
